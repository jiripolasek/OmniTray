...
<img src="./art/StoreLogo.png" alt="OmniTray logo" width="200" height="200">

<h1 align="center">OmniTray</h1>
<p><q>Drag tray is dead! Long live the drag tray!</q></p>

</div>

Temporarily shelf files, folders, text, and images while you work. OmniTray keeps dragged content in named, tinted stacks that can stay in compact floating trays, live on a screen-edge shelf, or be retrieved later from the central hub in notification area.
...
- **Keep editable sticky notes.** Add notes to a stack or attach them to an item. Browse active and recently deleted notes on the Stack organizer’s Notes page. Edit rich text in a small window, pick a pastel color, and move or reattach notes without losing their history. See [Notes](doc/notes.md).
...
OmniTray is licensed under the [Apache License 2.0](LICENSE.txt).
